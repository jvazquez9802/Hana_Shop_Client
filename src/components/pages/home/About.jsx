        ...
        <div className="about">
            <div className="about__content">
                <div className="about__left flex-center">
                    <h2 className="heading-secondary mt-lg">
                        <span className="heading-secondary--main">About Us</span>
                        <span className="heading-secondary--sub">We are a company dedicated to the sale and distribution of articles related to anime and videogame culture.</span>
                    </h2>
